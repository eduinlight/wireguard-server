...
iptables -D $IPTABLES_DOCKER_CHAIN -i $DOCKER_CONTAINER_INTERFACE -s $WG_CONTAINER_IP -j ACCEPT

# allow dns
iptables -D $IPTABLES_DOCKER_CHAIN -i $DOCKER_CONTAINER_INTERFACE -d $WG_DEFAULT_DNS -p dns --dport 53 -j ACCEPT
iptables -D $IPTABLES_DOCKER_CHAIN -i $DOCKER_CONTAINER_INTERFACE -s $WG_DEFAULT_DNS -p dns --sport 53 -j ACCEPT
